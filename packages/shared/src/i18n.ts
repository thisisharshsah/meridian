...
const en: Messages = {
  ...
  "action.newThing": "New {thing}",
  "action.backTo": "Back to {label}",
  "action.seeAllIn": "See all {n} in {label}",
  "action.next": "Next",
  ...
  "record.all": "All",
  "record.allOf": "All {label}",
  "record.pageSummary": "Page {page} of {pages} · {total} records",
  "record.boardSubset": "Showing the {n} most recent of {total}. Switch to the table for the full set.",
  "record.lookupSubset": "Showing {n} of {total}. Keep typing to narrow.",
  "record.addOneFirst": "Add one first →",
  "record.addFirstOf": "Add your first {label} first →",
  "record.convertLeadWhy": "Creates an account for {company} and a contact for {person}. The lead stays on record, marked converted.",
  ...
  "invite.sendLinkTo": "Send this link to {email}. It works once, expires in 14 days, and cannot be retrieved again — so copy it now.",
...
// ---- approvals ----
  ...
  "settings.business": "This business",
  ...
  "mobile.openInvite": "Open an invitation",
  "mobile.openInviteWhy": "Paste the link you were sent and it opens the business it belongs to.",
  "mobile.inviteLink": "Invitation link",
  "mobile.invitePlaceholder": "https://…/invite/…",
  "mobile.inviteUnreadable": "That does not look like an invitation link.",
